...
export default function Portfolio() {
  ...
  return (
    <div ref={rootRef} className={reduced ? "reduce" : ""}
      ...
      <ResumeModal open={resumeOpen} onClose={() => setResumeOpen(false)} reduced={reduced} closeOnBackdrop={false} />
        ...
        {menuOpen && (
          <div className="lg:hidden" style={{ background: "rgba(14,14,22,0.85)", backdropFilter: "blur(12px)", borderBottom: `1px solid ${THEME.border}` }}>
            <div className={`${CONTAINER} flex flex-col py-4 gap-4`}>
              ...
              <button onClick={() => { setResumeOpen(true); setMenuOpen(false); }} className="nav-link text-left inline-flex items-center gap-2" style={{ color: A }}>
              ...
              <div className="lg:col-span-3">
                ...
                <Reveal delay={400}>
                  <div className="mt-8 flex flex-wrap items-center gap-3">
                    ...
                    <button onClick={() => setResumeOpen(true)} className="btn-ghost inline-flex items-center gap-2 rounded-full px-5 py-3 text-sm"><FileText size={16} /> Resume</button>
